...
export const books: Book[] = [
  { id: 1, title: "Philosophy of the Masters (Gurmat Sidhant)", master: "Hazur Baba Sawan Singh Ji Maharaj", year: 1963, languages: ["English", "Hindi", "Punjabi"], categories: ["Sant Mat", "Philosophy", "Surat Shabd Yoga"], abstract: "A comprehensive five-volume exposition of the Sikh scriptures and Sant Mat philosophy, explaining the nature of God, the soul, and the path of Naam. Compiled from the teachings of Hazur Baba Sawan Singh Ji, this monumental work is considered a cornerstone of spiritual literature.", shelf: "Shelf A – Row 1 – Position 2", available: true },
  ...
  { id: 11, title: "Spiritual Elixir", master: "Param Sant Kirpal Singh Ji Maharaj", year: 1975, languages: ["English", "Hindi"], categories: ["Meditation", "Spirituality & Science"], abstract: "A rich collection of questions and answers from disciples' private correspondence with Sant Kirpal Singh, covering practical meditation guidance, spiritual experiences, and life situations on the inner path.", shelf: "Shelf B – Row 4 – Position 8", available: true },
